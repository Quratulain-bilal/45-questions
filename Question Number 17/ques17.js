...
while (guestlist.length > 2) {
    ...
    console.log("sorry , ".concat(removeguest, "  I cant invite you on the dinner"));
}
//sending invitation to the last two guests
console.log("Invitation to the lat two 2 guests");
guestlist.forEach(function (lasttwo) { return console.log("luckly ".concat(lasttwo, ",you are still invited o a dinner")); });
guestlist.pop();
guestlist.pop();
